...
class Game_Boss(Sprite):
	def __init__(self,game_settings,screen,player):
		...
		self.screen = screen
		self.image = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/left/move/bz1.png')
	...
	def attack_1(self,direction):
		...
		for self.j in range(0,34):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/'+direction+'/attack_1/%s.png' %self.j)
	...
	def attack_2(self,direction):
		...
		for self.j in range(0,30):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/'+direction+'/attack_2/%s.png' %self.j)
			self.players1.append(self.names1['player_image%s' %self.j])
		self.image = self.players1[int(self.pos_i)]
		self.pos_i += 0.5
		if self.pos_i >= 30:
	...
	def move(self,direction):#循环图片
		...
		for self.j in range(1,7):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/'+direction+'/move/bz%s.png' %self.j)
			self.players1.append(self.names1['player_image%s' %self.j])
		self.image = self.players1[int(self.pos_i)]
	...
	def run(self,direction):
		...
		for self.j in range(0,6):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/'+direction+'/run/%s.png' %self.j)
			self.players1.append(self.names1['player_image%s' %self.j])
		self.image = self.players1[int(self.pos_i)]
		self.pos_i += 0.3
		if self.pos_i >= 6:
	...
	def jump(self):			
		...
		for self.j in range(3,10):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/left/jump/%s.png' %self.j)
			self.players1.append(self.names1['player_image%s' %self.j])
	...
	def boom(self):
		...
		for self.j in range(1,4):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/boss/boom%s.png' %self.j)
			self.players1.append(self.names1['player_image%s' %self.j])

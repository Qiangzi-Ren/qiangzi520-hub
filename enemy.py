...
class Enemy(Sprite):
	def __init__(self,game_settings,screen):
		...
		self.screen = screen
		self.image = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/enemy/EL/bag2.png')
	...
	def boom(self):
		...
		for self.j in range(1,3):
			self.names1['player_image%s' %self.j] = pygame.image.load('//home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/enemy/boom%s.png' %self.j)
	...
	def update_run_direction(self,direction):#循环图片
		...
		for self.j in range(1,5):
			self.names1['player_image%s' %self.j] = pygame.image.load('/home/renziqiang/文档/matlab/15 魂斗罗/15 ╗Ω╢╖┬▐/═╝╞¼/enemy/'+direction+'/bag%s.png' %self.j)
			self.players1.append(self.names1['player_image%s' %self.j])

...
class Brick(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.brick = pygame.image.load('/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/scene/brick.png')
...
class Iron(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.iron = pygame.image.load('/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/scene/iron.png')
...
class Ice(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.ice = pygame.image.load('/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/scene/ice.png')
...
class River(pygame.sprite.Sprite):
	def __init__(self, kind=None):
		...
		self.rivers = ['/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/scene/river1.png', '/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/scene/river2.png']
...
class Tree(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.tree = pygame.image.load(' /home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/scene/tree.png')

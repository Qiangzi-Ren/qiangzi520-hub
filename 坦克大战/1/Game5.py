...
def show_start_interface(screen, width, height):
	tfont = pygame.font.Font('/home/renziqiang/文档/matlab/坦克大战/1/font/simkai.ttf', width//4)
	cfont = pygame.font.Font('/home/renziqiang/文档/matlab/坦克大战/1/font/simkai.ttf', width//20)
...
def show_end_interface(screen, width, height, is_win):
	bg_img = pygame.image.load("/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/others/background.png")
	screen.blit(bg_img, (0, 0))
	if is_win:
		font = pygame.font.Font('/home/renziqiang/文档/matlab/坦克大战/1/font/simkai.ttf', width//10)
		content = font.render(u'恭喜通关！', True, (255, 0, 0))
		rect = content.get_rect()
		rect.midtop = (width/2, height/2)
		screen.blit(content, rect)
	else:
		fail_img = pygame.image.load("/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/others/gameover.png")
...
def main():
	...
	while not is_gameover:
		...
		myhome = home.Home()
		# 出场特效
		appearance_img = pygame.image.load("/home/renziqiang/文档/matlab/坦克大战/1/═╝╞¼/others/appear.png").convert_alpha()
		appearances = []
